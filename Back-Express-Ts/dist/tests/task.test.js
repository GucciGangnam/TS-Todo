...
describe('POST /api/task', function () {
    ...
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        var newUserBody, newUserBody2, loginBody, loginBody2, loginResponse, loginResponse2, newList, newList2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    // Make the POST request to create a user
                    _a.sent();
                    return [4 /*yield*/, (0, supertest_1.default)(index_1.app).post('/api/users').send(newUserBody2)];
                case 3:
                    _a.sent();
                    loginBody = {
                        email: 'testtask@example.com',
                ...
                case 4:
                    ...
                    return [4 /*yield*/, (0, supertest_1.default)(index_1.app).post('/api/auth/login').send(loginBody2)];
                case 5:
                ...
                case 6:
                    ...
                    return [4 /*yield*/, (0, supertest_1.default)(index_1.app).post('/api/lists').set('Authorization', "Bearer ".concat(authToken2)).send({ listName: 'New List2' })];
                case 7:
                    newList2 = _a.sent();
    ...
    it('should create a new task sucesfully and', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, pool_1.default.query('SELECT * FROM tasks WHERE name = $1', ['New Task'])];
                case 2:
                    dbResult = _a.sent();
    ...
    it('should not be able to pass in another useres parent list id', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response, dbResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(index_1.app)
                ...
                case 1:
                    ...
                    return [4 /*yield*/, pool_1.default.query('SELECT * FROM tasks WHERE name = $1', ['New Sneak Task'])];
                case 2:
                    dbResult = _a.sent();
...
describe('PUT/api/task', function () {
    ...
    it('should sucesfully update all rows when all passed into the body', function () { return __awaiter(void 0, void 0, void 0, function () {
        var timeNow, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    timeNow = new Date();
    ...
    it('should sucesfully update ONLY the fields that are passed in and not effect the others', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(index_1.app)
...
describe('DELETE /api/task', function () {
    ...
    it('should sucesfully delete the task', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(index_1.app)
